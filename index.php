...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <a class="btn-getstarted" href="login.php">Oferecer Serviços</a>
      ...
      <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6">
            ...
            ?>
              <span data-purecounter-start="0" data-purecounter-end="<?PHP echo($row['QTD'])?>" data-purecounter-duration="1" class="purecounter"></span>
              <p>Eventos Realizados</p>
            </div>
          </div><!-- End Stats Item -->
          <?PHP
              $sql = "SELECT COUNT(*) AS 'QTD' FROM tbl_servico";
              $result = $conn->query($sql);
              $row = $result->fetch_assoc();
            ?>
          <div class="col-lg-4 col-md-6">
          ...
          <?PHP
              $sql = "SELECT COUNT(*) AS 'QTD' FROM tbl_usuario";
              $result = $conn->query($sql);
              $row = $result->fetch_assoc();
            ?>
          <div class="col-lg-4 col-md-6">
      ...
      <div class="container">
        ...
        <?PHP
            $sql = "SELECT
                        ...
                        tbl_usuario.nome,
                        entrada
                        FROM tbl_evento JOIN tbl_usuario ON tbl_usuario.id = tbl_evento.organizador ORDER BY data DESC LIMIT 6";
            $result = $conn->query($sql);
          ?></p>
      </div><!-- End Section Title -->
